                ...
                <c:choose>
                    ...
                    <c:otherwise>
						<span class="dropdown ps-5">
							...
							<ul class="dropdown-menu">
                                <li><a class="dropdown-item text-dark py-2" href="verPerfil">Ver perfil</a></li>
                                <li><a class="dropdown-item text-dark py-2" href="listarSandwich">Listar Sandwich</a></li>
...
<main>
    <section>
        <div id="banner" class="d-flex justify-content-center">
            <img src="${pageContext.request.contextPath}/img/bannerganccic222.png" class="img-fluid" alt="bannerganccic">
            <div id="bannerTitulo">
                <h1>GANIC</h1>
            </div>
                            ...
                            <div class="card">
                                ...
                                <ul class="list-group list-group-flush">
                                    ...
                                    <li class="list-group-item"><span
                                            class="text-primary">Es apto:</span> ${sandwich.esApto}</li>
                                    <li class="list-group-item"><a
                                            href="confirmarSandwich?idSandwich=${sandwich.idSandwich}"
                                            class="btn btn-success px-3 my-3">Comprar</a></li>
                                </ul>
                            </div>
                        </div>
                    </c:forEach>
            ...
            <div class="row my-5 py-5">
                    ...
                    <div id="carouselExampleInterval" class="carousel slide" data-bs-ride="carousel">
                        <div class="carousel-inner">
                            <div class="carousel-item active" data-bs-interval="3000">
                                <img src="${pageContext.request.contextPath}/img/s01.png" class="d-block w-100" alt="...">
                            </div>
                            <div class="carousel-item" data-bs-interval="3000">
                                <img src="${pageContext.request.contextPath}/img/s02.png" class="d-block w-100" alt="...">
                            </div>
                            <div class="carousel-item" data-bs-interval="3000">
                                <img src="${pageContext.request.contextPath}/img/s03.png" class="d-block w-100" alt="...">
                            </div>
                            <div class="carousel-item" data-bs-interval="3000">
                                <img src="${pageContext.request.contextPath}/img/s04.png" class="d-block w-100" alt="...">
                            </div>
                        </div>
                ...
                <div class="col-6">
                    ...
                    <p class="text-center mt-4 p-5">
                        Nuestro menú ofrece variedad de sandiwchs caseros de estilo gourmet, llenos de sabor preparados
                        con
                        ingredientes frescos y naturales, satisfaciendo hasta los más exigentes paladares. Ofrecemos un
                        servicio de
    ...
    <div class="container">
        <div class="row pt-3 text-white">
            ...
            <div class="col-3 text-end">
                <img src="${pageContext.request.contextPath}/img/ganiclogo.png" class="img-fluid logo_style" alt="Logo">
            </div>
        </div>
    </div>
</footer>
